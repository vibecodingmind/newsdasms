...
const CORE_REASONS = [
  ...
  },
  {
    ...
    description:
      'No SMS service provider in the text messaging industry competes with our pricing. We believe that cost should never be a barrier to spreading the Gospel, so we have structured our pricing to be the most affordable on the continent. From our Starter Pack at just Tsh 34,900 to our volume discounts that bring per-SMS costs down to Sh 11, every ministry — regardless of size — can access professional messaging tools without straining their budget.',
    color: '#7C3AED',
  },
  {
    icon: Globe,
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <FadeInWhenVisible>
              ...
              <p className="text-white/50 text-base sm:text-lg leading-relaxed mb-10 max-w-2xl mx-auto font-medium">
                ...
                to deliver their message. Start with our Starter Pack — 2,500 SMS and 1 Sender ID for just Tsh 34,900.
              </p>
